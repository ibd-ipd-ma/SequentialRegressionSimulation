...
################################################################################
# Overview: this file record published baseline characteristics and outcome summaries 
# of each study and compare them to IPD results
...
library(patchwork)  # patching multiple plots together
